...
This module exposes only ``restart_compose_service`` — the only operation
concord-api needs. If we ever need more (start, stop, inspect volumes),
extend here rather than scattering docker calls across routers.
"""
